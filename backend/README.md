...
## Project Structure
    ...
    ├── test6inghj_dev_67227  # Django project configurations
...
1. Clone this repo and `cd test6inghj_dev_67227`
...
2. Clone this repo and `cd test6inghj_dev_67227`
