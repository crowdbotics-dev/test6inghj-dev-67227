"""
Django settings for test6inghj_dev_67227 project.
...
ROOT_URLCONF = 'test6inghj_dev_67227.urls'
...
WSGI_APPLICATION = 'test6inghj_dev_67227.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test6inghj_dev_67227 API",
    "DESCRIPTION": "API documentation for test6inghj_dev_67227 App",
    "VERSION": "v1",
}
